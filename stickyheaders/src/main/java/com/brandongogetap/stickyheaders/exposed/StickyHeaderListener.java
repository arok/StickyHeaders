...
public interface StickyHeaderListener {
     ...
     */
    void headerAttached(RecyclerView.ViewHolder headerView, int adapterPosition);
     ...
     * by a call to {@link StickyHeaderListener#headerAttached(RecyclerView.ViewHolder, int)} with the same view instance,
     ...
     */
    void headerDetached(RecyclerView.ViewHolder headerView, int adapterPosition);
}
